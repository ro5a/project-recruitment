...
<head>
    ...
    <link rel="stylesheet" href="css/style-career.css">
    ...
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light ">
            <div class="container-fluid">
              <a class="navbar-brand navbar-left" href="#" style="color: #FFC312;font-weight: bolder;font-size: 30px;">
               Jobs
              </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button"style="background-color: #233d7b;" class="btn btn-primary">Submit</button>
        <a class="nav-link login"  style="color: #fff;" > <button type="button"style="background-color: #233d7b;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
           Sign up
        </button></a>
      </div>
    ...
    <div class="contact">
        <div class="other">
            <div class="info">
                <h2>Contuct us </h2>
                <h3>Email</h3>
                <div class="svg-wrap"> <a href="mailto:"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.211 485.211">
                            <path d="M485.21 363.906c0 10.637-2.99 20.498-7.784 29.174l-153.2-171.41 151.54-132.584c5.894 9.355 9.445 20.344 9.445 32.22v242.6zM242.607 252.793l210.863-184.5c-8.654-4.737-18.398-7.642-28.91-7.642H60.65c-10.523 0-20.27 2.906-28.888 7.643l210.844 184.5zm58.787-11.162l-48.81 42.735c-2.854 2.487-6.41 3.73-9.977 3.73-3.57 0-7.125-1.243-9.98-3.73l-48.82-42.736-155.14 173.6c9.3 5.834 20.198 9.33 31.984 9.33h363.91c11.785 0 22.688-3.496 31.984-9.33l-155.15-173.6zM9.448 89.086C3.554 98.44 0 109.43 0 121.305v242.602c0 10.637 2.978 20.498 7.79 29.174L160.97 221.64 9.448 89.086z" /></svg> roor3hakimi@gmail.com</a> </div>
                <h3>Connect</h3>
                <div class="svg-wrap"> <a href="http://instagram.com/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div class="form">
            ...
            <form action="">
                ...
                <div class="flex-rev"> <input type="text" placeholder="Enter your name" name="name" id="name" class="form-control"/> <label for="name">Full Name</label> </div>
                <div class="flex-rev"> <input type="email" placeholder="example@gmail.com" name="email" id="email"class="form-control" /> <label for="email">Your Email</label> </div>
                <div class="flex-rev"> <textarea placeholder=" write your message" name="message" id="message" class="form-control"></textarea> <label for="message">Email Message</label> </div> <button class="btn btn-primary" style="background-color:#233d7b; color: #fff; border-radius: 10px;">Send Email</button>
            </div>
            </form>
        </div>
    </div>
